    ...
    <div class="px-4 py-4 shadow xl:px-72 lg:px-28">
        ...
        <div class="flex gap-4">
            <div class="flex flex-col flex-1 gap-4">
                ...
                <textarea name="" id="" class="flex-1 p-2 border rounded" placeholder="La description de l'info" wire:model="descri"></textarea>
            </div>
            <div class="grid grid-rows-2 gap-4"x-data="{ isUploading: false, progress: 0 }"
        ...
        <div class="grid grid-cols-4 gap-4">
            ...
            @foreach ($infos as $inf)
                <a class="flex flex-col justify-center p-2 text-center shadow" href="#" wire:click="charger({{$inf}})">
                    ...
                    <p class="text-gray-400">{{$inf->descri}}</p>
                </a>
            @endforeach
        </div>
    </div>
