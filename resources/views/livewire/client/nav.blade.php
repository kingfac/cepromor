<div class="top-0 w-full bg-black-transparent-nav" x-data="{cepro:false, domaine:false, open:false}" {{-- :class="{'bg-black-transparent-nav':cepro===false, 'bg-black-transparent-nav-1':cepro===true}" --}} id="nav" x-init="navInit()">
