<div class="" style="background-image: url({{asset('images/IMG_20200511_091026.jpg')}})" id="projetRecent">
    ...
    <div class="flex flex-col justify-between gap-4 px-5 py-20 pb-10 xl:px-60 md:px-10 lg:px-20 bg-image-1 gradient" >
        ...
        <div class="flex flex-col md:flex-row">
            <div class="flex-1 text-justify">
                ...
                <div class="py-4 font-bold text-white md:text-3xl">
                    <h1>{{$projets[0]->nom}}</h1>
                </div>
